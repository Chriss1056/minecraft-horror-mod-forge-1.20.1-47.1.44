...
public class modCreativeModeTabs
{
    ...
    public static final RegistryObject<CreativeModeTab> TEST_TAB_1 = CREATIVE_MODE_TABS.register("test_tab_1",
    ...
    public static final RegistryObject<CreativeModeTab> TEST_TAB_2 = CREATIVE_MODE_TABS.register("test_tab_2",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(modItems.TEST_ITEM_1.get()))
